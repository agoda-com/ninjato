[ninjato-core](../../index.md) / [com.agoda.ninjato.http](../index.md) / [Method](index.md) / [Options](./-options.md)

# Options

`object Options : `[`Method`](index.md)

Represents the `OPTIONS` http method. [Body](../-body/index.md) is not required.
